...
function EnquiryInner() {
  ...
  const [formData, setFormData] = useState({
    name: "", email: "", phone: "", subject: "", projectType: "Business Website", budget: "",
    plan: planParam && PLAN_LABELS[planParam] ? PLAN_LABELS[planParam] : "",
    message: "",
  });
        ...
        <div className={styles.grid}>
          <div className={styles.info}>
            <Reveal>
              ...
              <TextReveal text="Get in Touch" tag="h2" className={styles.title} />
